...
Para atualizar depois, refaça o clone temporário ou mantenha este repo num diretório próprio e crie links simbólicos.
...
| `content-machine-pro` | Versão premium. Imagem de fundo gerada por IA ou buscada na web, paleta derivada da marca, estilos Editorial/Clean/Bold/Minimal, sem marca d'água. Use esta como padrão. |
...
| Skill | Para que serve |
|---|---|
| `secret-event-video` | Vídeos verticais de 45–50s a partir de filmagem de evento, em Remotion. Dois formatos: recap e manifesto. Estilo travado no componente; o conteúdo entra por JSON. |
...
Código sob MIT, veja [LICENSE](LICENSE). Nem tudo aqui é de minha autoria: veja [ATTRIBUTION.md](ATTRIBUTION.md) antes de redistribuir.
